...
const CITIES: ICity[] = [
    ...
    },
    {
        ...
        name: "Turbo",
        description:
            "Turbo es un distrito de Colombia localizado en la subregión de Urabá en el departamento de Antioquia. Fue declarado por ley de la república 1883 de 2018 distrito especial portuario, logístico, industrial, turístico y comercial.",
        surface: 3055,
        population: 124552,
        postalCode: "57860",
        departmentId: 2,
    ...
    },
    {
        ...
        description:
            "El Carmen de Bolívar es un municipio del departamento de Bolívar, Colombia, ubicado en el sistema orográfico de los Montes de María, siendo la población más grande, así como la que concentra el movimiento económico y comercial de la subregión. Está a 120 km al sudeste de Cartagena de Indias y a 69 km al norte de Sincelejo.",
        surface: 954,
        population: 70131,
        postalCode: "132050",
        departmentId: 6,
    ...
    },
    {
        ...
        name: "Florencia",
        description:
            "Florencia es un municipio colombiano, capital del departamento de Caquetá. Es el municipio más poblado de la región amazónica por su número de habitantes.5​ Es conocido como «La Puerta de Oro de la Amazonía Colombiana»",
        surface: 2292,
        population: 173011,
        postalCode: "180001",
        departmentId: 9,
    ...
    },
    {
        ...
        description:
            "Santander de Quilichao es un municipio colombiano ubicado en el sector norte del departamento del Cauca, a 97 km al norte de Popayán y a 45 km al sur de Cali. Límites: al norte con los Municipios de Villa Rica y Jamundí, al Occidente con el municipio de Buenos Aires, al oriente con los municipios de Caloto y Jambaló y al sur con el Municipio de Caldono",
        surface: 518,
        population: 95041,
        postalCode: "191030",
        departmentId: 11,
    ...
    },
    {
        ...
        name: "Montelíbano",
        description:
            "Montelíbano es un municipio del sur del departamento de Córdoba, Colombia. Situado sobre la margen derecha del río San Jorge y con una población de 90.4504​ habitantes aproximadamente, es en la actualidad uno de los centros de desarrollo económico, comercial y cultural más importantes de la región.",
        surface: 1890,
        population: 90450,
        postalCode: "234001",
        departmentId: 14,
    ...
    },
    {
        ...
        name: "Pitalito",
        description:
            "Pitalito es un municipio colombiano localizado en el suroriente del departamento del Huila. Yace sobre el valle del Magdalena y sobre el vértice que forman las Cordilleras central y oriental. Su extensión territorial de 653km², su altura de 1318 metros sobre el nivel del mar y su temperatura promedio de 18-21 ",
        surface: 653,
        population: 128600,
        postalCode: "417030",
        departmentId: 18,
    ...
    },
    {
        ...
        name: "Ipiales",
        description:
            "Ipiales es un municipio colombiano ubicado en el departamento de Nariño. Situado en la frontera con Ecuador, en el nudo de los Pastos, en el altiplano andino, relativamente cerca de la costa del océano Pacífico (aproximadamente a cinco horas en bus), al pie de monte amazónico y a la línea equinoccial, siendo una región panamazónica.",
        surface: 1707,
        population: 148000,
        postalCode: "524060",
        departmentId: 22,
    ...
    },
    {
        ...
        name: "Ocaña",
        description:
            "Ocaña es un municipio colombiano ubicado en el departamento de Norte de Santander, al nororiente del país. Se encuentra dentro de la Subregión de Occidente, conocida coloquialmente como la Provincia de Ocaña. El municipio cuenta con una extensión de 672,27 km² y una altitud media de 1202",
        surface: 672,
        population: 129308,
        postalCode: "546551",
        departmentId: 23,
    ...
    },
    {
        ...
        name: "Pamplona",
        description:
            'Pamplona es un municipio colombiano, ubicado en el departamento de Norte de Santander. Fue la capital de la Provincia de Pamplona y su economía está basada en la gastronomía, la agricultura, el turismo (especialmente el turismo religioso) y la educación. Se le conoce como la "Ciudad Mitrada", debido a que en ella se instauró la Arquidiócesis de Nueva Pamplona',
        surface: 318,
        population: 59422,
        postalCode: "543050",
        departmentId: 23,
    ...
    },
    {
        ...
        name: "Tuluá",
        description:
            "Tuluá es un municipio colombiano ubicado en la región central del departamento del Valle del Cauca.3​ Es un motor comercial, demográfico, cultural, industrial, financiero y agropecuario del centro del departamento. Posee una cámara de comercio y es el cuarto municipio más poblado del Valle del Cauca",
        surface: 910,
        population: 218812,
        postalCode: "764501",
        departmentId: 31,
